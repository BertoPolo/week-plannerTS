...
const Footer = () => {
  return (
    <footer className="footer p-10 mt-10 bg-base-200 text-base-content">
      ...
      <nav>
        <header className="footer-title">Used Tecnologies</header>
      ...
      <nav>
        ...
        <Link className="link link-hover" target="_blank" rel="noopener noreferrer" href="https://github.com/BertoPolo">
          {<AiFillGithub />}
        </Link>
      </nav>
    </footer>
